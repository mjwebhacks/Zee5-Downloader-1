...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🚀 CHANNEL 🚀", url="https://t.me/ML_BotUpdates")], [InlineKeyboardButton(text="🚨SUPPORT🚨", url="https://t.me/ML_SupportGroup"),
